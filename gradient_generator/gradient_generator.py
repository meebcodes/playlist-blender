...
if __name__ == '__main__':
    ...
    # tennis: glorietta
    img_data = gen_linear_horiz_grad_from_attr(tempo=169.034, valence=0.799, energy=0.839, acousticness=0.0183)
    img = Image.open(fp=img_data)
    img.save(fp="glorietta.png")

    # flying saucer attack: my dreaming hill
    img_data = gen_linear_horiz_grad_from_attr(tempo=128.090, valence=0.197, energy=0.696, acousticness=0.233)
    img = Image.open(fp=img_data)
    img.save(fp="dreaming.png")

    # tv priest: bury me in my shoes
    img_data = gen_linear_horiz_grad_from_attr(tempo=134.011, valence=0.0712, energy=0.663, acousticness=0.000184)
    img = Image.open(fp=img_data)
    img.save(fp="bury.png")

    # measuring windows playlist
    img_data = gen_linear_horiz_grad_from_attr(tempo=115.35723333333331, valence=0.35263999999999995, energy=0.6138333333333332, acousticness=0.32758713)
    img = Image.open(fp=img_data)
